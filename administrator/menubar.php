...
$query = "SELECT * FROM menubar where section_type = 'menu'";
            ...
            <table class="table">
              ...
              <tbody><?php foreach ($records as $key => $value) : ?>
                  <tr id="record_<?php echo $value['id']; ?>">
                    ...
                    <td>
                      <a href="edit_form_menubar.php?id=<?php echo $value['id']; ?>">Edit</a> |
...
<main  class="topbarForm" id="main">
  <div class="card">
    <div class="card-body">
      ...
      <!-- Multi Columns Form -->
      <form class="row g-3" id="form" action="insert_form_fun_menu.php" method="post">
        <div class="col-md-6">
          <label for="inputCity" class="form-label" >Section Type</label>
          <input type="text" class="form-control" id="inputCity" name="section_type" value="menu">
        </div>
